...
app.get("/products_display", function (request, response, next) {
...
<script>
	...
	function checkQuantityTextbox(theTextbox) {
		// EC IR2: Added additional text and font styles to indicate whether quantities were valid or not
		...
		if (error_array.length == 0) {
			// EC IR2 (pt.2): if there are no errors...
